...
class AnimeDex:
    ...
    def search(query):
        url = 'http://new.animedex.live/search?query=' + \
        ...
        for anime in soup.find('div', 'divox').find_all('a'):
            ...
            url = 'https://new.animedex.live' + anime.get('href')
    ...
    def anime(url):
        ...
        for i in eps:
            ep.append((i.text, 'https://new.animedex.live' + i.get('href')))
